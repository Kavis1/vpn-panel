...
const SubscriptionDetailsPage: React.FC = () => {
  ...
  const { data: usageData, isLoading: isLoadingUsage } = useQuery({
    queryKey: ['subscription-usage', subscriptionId, startDate, endDate, granularity],
    queryFn: () => getSubscriptionUsage(subscriptionId!, { startDate, endDate, granularity }),
  ...
  const { data: logsData, isLoading: isLoadingLogs } = useQuery({
    queryKey: ['subscription-logs', subscriptionId, logsPage, logsPerPage],
    queryFn: () => getSubscriptionLogs(subscriptionId!, {
