...
class User(Base):
    ...
    vpn_users = relationship("VPNUser", back_populates="user")
    created_configs = relationship("ConfigVersion", back_populates="created_by")
    xray_configs_created = relationship("XrayConfig", foreign_keys="XrayConfig.created_by", back_populates="creator")
    xray_configs_updated = relationship("XrayConfig", foreign_keys="XrayConfig.updated_by", back_populates="updater")
